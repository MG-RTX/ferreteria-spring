...
public class FacturaDetalleServicioTestUnitaria {
    ...
    @InjectMocks
    private ProductoServiceImpl libroService;
    ...
    public void setUp(){
        ...
        facturaDetalle = new FacturaDetalle(1,2,23.23, producto,factura);
        factura = new Factura(1,"FAC-001",new Date(),155.00,12.00,177.00,cliente);
        producto = new Producto(1,"Romeo","Santillan",12,"Limitada","Español",new Date(),"Larga","Roja","ISBN",12,"Buena","Mala",12.00,categoria, proveedor);
    }
    ...
    @Test
    public void update(){
        FacturaDetalle facturaDetalleActualizada = new FacturaDetalle(1,1,12.22, producto,factura);
        when(facturaDetalleRepository.findById(1)).thenReturn(Optional.of(facturaDetalle));
