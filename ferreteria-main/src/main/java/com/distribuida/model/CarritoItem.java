...
public class CarritoItem {
    ...
    @JsonIgnoreProperties({"proveedor","categoria"})
    @ManyToOne(optional = false)
    ...
    public CarritoItem(Long idCarritoItem, Carrito carrito, Producto producto, Integer cantidad, BigDecimal precioUnitario, BigDecimal total) {
