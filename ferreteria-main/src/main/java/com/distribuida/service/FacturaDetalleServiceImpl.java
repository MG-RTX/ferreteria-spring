...
public class FacturaDetalleServiceImpl implements FacturaDetalleService {
    ...
    @Override
    public FacturaDetalle update(int id, int idFactura, int idProducto, FacturaDetalle facturaDetalle) {
        ...
        facturaDetalleExistente.setProducto(productoExistente.orElse(null));
