...
public class FacturaDetalleController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<FacturaDetalle> update(@PathVariable int id, @PathVariable int idFactura , @PathVariable int idProducto, @RequestBody FacturaDetalle facturaDetalle){
        FacturaDetalle facturaDetalleActualizada = facturaDetalleService.update(id,idFactura,idProducto,facturaDetalle);
